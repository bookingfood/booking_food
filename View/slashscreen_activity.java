...
public class slashscreen_activity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if(vitriHienTai != null){
            ...
            Log.d("longitude", String.valueOf(vitriHienTai.getLongitude()) + " "+String.valueOf(vitriHienTai.getLatitude()));
            editor.commit();
        }
        ...
        try {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent iDangNhap = new Intent(slashscreen_activity.this,DangNhap_activity.class);
