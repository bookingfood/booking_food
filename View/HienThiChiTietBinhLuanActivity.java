...
import com.example.booky.Adapters.AdapterRecyclerHinhBinhLuan;
...
public class HienThiChiTietBinhLuanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        circleImageView = (CircleImageView) findViewById(R.id.circleimgbl);
        txtTieuDeBinhLuan = (TextView) findViewById(R.id.txtDiembl1);
        txtNoiDungBinhLuan = (TextView) findViewById(R.id.txtnoidungbl);
        txtSoDiem = (TextView) findViewById(R.id.txtDiembl1);
